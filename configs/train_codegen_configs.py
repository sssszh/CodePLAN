...
parser = argparse.ArgumentParser(description="Training CodeGen for code generation")
parser.add_argument('--model', default='codegen-350M-mono', type=str, help='type of transformers model as model backbone')
...
parser.add_argument('--grad-acc-steps', default=32, type=int, help='number of training steps before each gradient update')
