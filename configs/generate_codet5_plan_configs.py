...
parser = argparse.ArgumentParser(description="Run CodeT5 model to generate plans.")

parser.add_argument("-t","--test_path", default="", type=str, help='Path to test samples')
parser.add_argument("--output_path", default="",type=str, help='Path to save output plans') 
...
parser.add_argument('--num_seqs_per_iter', default=5, type=int, help='Number of possible minibatch to generate plans per iteration, depending on GPU memory')
...
parser.add_argument("--is_plan", default=True, type=bool, help="")
...
parser.add_argument("-e","--end", default=700, type=int, help='end index of test samples')
